...
<html>
    ...
    <title>Reporte Gastos por Cartel</title>
    <style>
        body {
        /*position: relative;*/
        /*width: 16cm;  */
        ...
        <header>
            ...
            <div id="datos">
                <p id="encabezado">
                    ...
                    <b>Sistema de gestion de gastos Viñas</b><br>Informe de gastos por curtel<br>
                </p>
            </div>
            <div id="fact">
        ...
        <section>
            <div>
                <table id="facliente">
                    <thead>                        
                        <tr>
                            <th id="fac">{{Auth::user()->usuario}} </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        <th><p id="cliente">Cuartel:{{$nombre}}<br>
                            Labor:Todos<br>
                            
                            Intervalo {{$inicio}} a {{$termino}}
                            </p></th>
                        </tr>
                    </tbody>
                </table>
